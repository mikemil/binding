            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.type.label" default="Icon Type" /></td>
                            
                            <td valign="top" class="value">${userInstance?.type?.encodeAsHTML()}</td>
                            
                        </tr>
                    
                        <g:if test="${userInstance?.type == IconType.LOCAL_PHOTO}">
                           <tr class="prop">
                              <td valign="top" class="name"><g:message code="user.photo.label" default="Photo" /></td>
                               <td>
